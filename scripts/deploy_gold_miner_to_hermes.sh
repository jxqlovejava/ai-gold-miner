...
echo ""
echo "==> 部署监控脚本"
for script in adaptive_gold_monitor.py overnight_news_scanner.py evening_event_preview.py price_surge_monitor.py profit_protection_monitor.py gold_stop_level_alert.py hermes_delivery_watchdog.py; do
